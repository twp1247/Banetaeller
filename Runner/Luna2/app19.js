const KEY="stafet_checkpoints_v19";
...
clearBtn=document.getElementById("clear"),downloadBtn=document.getElementById("download"),nextEl=document.getElementById("next"),
...
function renderSaved(){
  ...
  startBtn.disabled=!allSaved()||running;downloadBtn.disabled=!allSaved();
